    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          type: 'string',
          title: 'Meta Tytuł',
          description: 'Tytuł wyświetlany w wynikach wyszukiwania (zalecane: 50-60 znaków)',
        ...
        defineField({
          ...
          type: 'text',
          title: 'Meta Opis',
          description: 'Opis wyświetlany w wynikach wyszukiwania (zalecane: 150-160 znaków)',
          rows: 3,
